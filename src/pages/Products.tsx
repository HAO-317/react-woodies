        ...
        <section className="product-section">
          ...
          <div className="product-list">
            <article className="product-card">
              ...
              <img className="product-card_image" src='/img/Tisch.png' alt="Jenson product" />
              <Link to="/jenson" className="product-card_button">Shop now</Link> 
            </article>
            <article className="product-card">
              <h2 className="product-card_title">Deon</h2>
              <img className="product-card_image" src='/img/Stuhl.png' alt="Deon product" />
              <Link to="/deon" className="product-card_button">Shop now</Link> 
            </article>
            <article className="product-card">
              <h2 className="product-card_title">Krisha</h2>
              <img className="product-card_image" src='/img/Schuesseln.png' alt="Krisha product" />
